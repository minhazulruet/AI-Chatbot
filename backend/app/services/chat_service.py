...
class ExplainerAgent:
    ...
    def explain(self, query: str, retrieved_contexts: List[Dict]) -> str:
        ...
        # Create system prompt for explainer
        system_prompt = """You are an expert educational tutor explaining concepts to students.
Your role is to:
...
5. Suggest related concepts or topics for deeper learning
...
Please explain this concept to the student in a clear, engaging way. Use the provided context from the textbook to support your explanation."""
